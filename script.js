...
const workouts = {
  Sunday: [], // Yoga/rest day - will show yogaSessions
  ...
  Tuesday: [
    ...
    { name: "Incline Walk", img: "images/treadmill.jpg", video: "https://www.youtube.com/watch?v=QJ5xNKn9nBU", sets: 1, reps: "10 min" }
  ],
  ...
  Thursday: [], // Yoga or mobility day

  Friday: [], // Optional rest or recovery day

  Saturday: [] // You can choose to add legs, cardio or full-body here later
};
